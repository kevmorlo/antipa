...
{
    const DISPLAY_ERROR = 'Une erreur est survenue lors de l\'affichage des localisations. ';
    const CREATE_ERROR = 'Une erreur est survenue lors de la création du la localisation. ';
